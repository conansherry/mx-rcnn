...
class ProposalFPNProp(mx.operator.CustomOpProp):
    def __init__(self, feat_stride='(32,16,8,4)', scales='(8)', ratios='(0.5, 1, 2)', output_score='False',
                 rpn_pre_nms_top_n='6000', rpn_post_nms_top_n='300', threshold='0.3', rpn_min_size='(32,16,8,4)'):
